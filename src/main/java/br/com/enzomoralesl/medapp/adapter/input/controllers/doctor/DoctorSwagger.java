...
public interface DoctorSwagger {
    ...
    @Operation(
            ...
            summary = "Endpoint responsible  for creating a new doctor",
            description = "Endpoint responsible for creating a new doctor"
    )
    @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "CREATED")})
    ResponseEntity<DoctorResponse> createDoctor(DoctorRequest request, UriComponentsBuilder uriBuilder);

    @Operation(
            operationId = "fetchDoctor",
            summary = "Endpoint responsible for searching a doctor",
            description = "Endpoint responsible for searching a doctor"
    )
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "OK")})
    ResponseEntity<DoctorResponse> fetchDoctor(String crm) throws ResourceNotFoundException;
