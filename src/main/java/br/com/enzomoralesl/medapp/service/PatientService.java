...
public class PatientService implements IPatientService {
    ...
    public IJPAPatientRepository jpaPatientRepository;
    IPatientMapper mapper;

    public PatientService(IJPAPatientRepository jpaPatientRepository, @Qualifier("IPatientMapperImpl") IPatientMapper mapper) {
    ...
    public PatientResponse save(PatientRequest request) {
        ...
        return new PatientResponse(
                ...
                mapper.toMedicalRecordDTO(patientEntity.getMedicalRecord()),
